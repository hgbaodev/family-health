...
const MemberDetail = () => {
  ...
  return (
    <Col span={12} className="bg-white p-6 rounded-lg shadow-md overflow-y-scroll" style={{
      maxHeight: "calc(100vh - 100px)"
    }}>
      <Row justify="center" className="mb-4">
        <h2 className="text-xl font-bold text-primary">Thông tin chi tiết</h2>
      </Row>
      <Divider />
      <Row gutter={[16, 16]}>
        <Col span={12}>
        ...
        <Col span={12}>
          <Space direction="vertical" size="middle" className="w-full">
            ...
            <div className="flex">
              ...
              <span>{memberDetail?.height ? `${memberDetail.height} cm` : "Chưa cập nhật"}</span>
            </div>
            <div className="flex">
              <span className="font-bold w-[120px]">Cân nặng:</span>
              <span>{memberDetail?.weight ? `${memberDetail.weight} kg` : "Chưa cập nhật"}</span>
            </div>
          </Space>
        </Col>
      </Row>
