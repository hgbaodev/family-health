...
import CreateDepartmentModal from "~/sections/Department/CreateDepartmentModal";
  ...
  return (
    <>
      <Flex align="center" justify="space-between" className="mb-5">
        <HeaderBreadcrumbs
          heading="Quản lý bộ môn"
          links={[{ title: "Home", href: "/" }, { title: "Bộ môn" }]}
        />
        <Button
          type="primary"
      ...
      >
        ...
        <Table.Column title="Tên bộ môn" dataIndex="name" key="name" sorter />
        <Table.Column
          title="Thao tác"
          key="action"
          width="10%"
      ...
      <CreateDepartmentModal open={openCreate} onCancel={closeCreate} />
      <UpdateMajorDialog
        record={record}
        open={openUpdate}
